...
def create_app(): # create_app 함수가 app 객체를 생성하고 반환 (애플리케이션 팩토리)
    ...
    # Blueprint
    from .views import main_views, question_views, answer_views, auth_views, comment_views, vote_views, merchant_list_views, work_status_views# question_views 파일에 등록한 블루프린트 적용
    ...
    app.register_blueprint(merchant_list_views.bp)
    app.register_blueprint(work_status_views.bp)
